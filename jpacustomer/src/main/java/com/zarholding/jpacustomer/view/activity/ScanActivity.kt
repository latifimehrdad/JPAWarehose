...
import com.zarholding.jpacustomer.databinding.ScanActivityBinding
...
//                    .show()
            ...
            override fun receiveDetections(detections: Detections<Barcode>) {
                ...
                if (barcodes.size() == 1) {
                    ...
                    runOnUiThread {
                        cameraSource.stop()
//                        Toast.makeText(this@ScanActivity, "value- $scannedValue", Toast.LENGTH_SHORT).show()
                ...
                {
//                    Toast.makeText(this@ScanActivity, "value- else", Toast.LENGTH_SHORT).show()
